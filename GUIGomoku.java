...
import net.jurinson.Impl.DefaultGameTable;
import net.jurinson.Impl.DefaultHumanTurn;
import net.jurinson.Impl.DefaultComputerTurn;
import net.jurinson.Impl.DefaultWinnerChecker;
...
public class GUIGomoku extends JFrame{
    ...
    private transient final GameTable gameTable;
    private transient final HumanTurn humanTurn;
    private transient final ComputerTurn computerTurn;
    private transient final WinnerChecker winnerChecker;
    ...
    protected void markWinnerCells(List<Cell> winnerCells) {
        for (int i = 0; i < winnerCells.size(); i++) {
            ...
            cells[cell.getRowIndex()][cell.getColIndex()].setForeground(Color.BLACK);
    ...
    protected void startNewGame() {
        ...
        LOGGER.info("------------------------------------------------------");
        LOGGER.info("New game started with game table {}x{} {}",
                gameTable.getSize(), gameTable.getSize(),
